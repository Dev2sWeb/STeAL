...
const Todo = () => {
    ...
    const edititem = (ind) =>
    {
        ...
        // let ans=document.getElementsByClassName('additems')
        // let spac=document.createElement('br')
        // ans.innerHTML+="<h2>Ans.</h2>"
                ...
                <div className="child-div">
                    ...
                    <div className="">                    
                        <div className="input-group input-group-sm mb-3">
                            ...
                            <input type="text" className="additems" value={intask} onChange={(e) => setintask(e.target.value)} id="inp" placeholder="Ask a question here" />
                            {
